...
describe('Quora simulation', function(){
    ...
    it('PUT /answer/5ccfa29a6df7dc08985b1580/upvote',function(){
        agent.put('/answer/5ccfa29a6df7dc08985b1580/upvote')
            .set({'Authorization':'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImpvaG4uc21pdGhAc2pzdS5lZHUiLCJ1c2VyX2lkIjoiNWNkMWQ3YzIxNGY3NmUzNmVkYTYzZjBkIiwiaWF0IjoxNTU3Mjc0NDIwfQ.ItJ0CmHusYy7vkegfP0EuNkqI0cbSgpzBdCpHRxr3mM'})
            .end(function(err, res) {
